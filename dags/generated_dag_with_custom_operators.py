...
from custom_operators.extract_operator import ExtractOperator
from custom_operators.transform_operator import TransformOperator
from custom_operators.load_operator import LoadOperator
...
dag = DAG(
    'example_dynamic_dag_with_custom_operators',
